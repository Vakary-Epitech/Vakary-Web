  ...
  <div id="app">
    ...
    <div>
      ...
      <div class="parentVakaryWeb">
        ...
        <h3 class="rightSubtitleVakaryWeb">Notre partenariat avec nos guides touristiques nous permettent d'avoir les
          meilleurs
          résumés</h3>
      </div>
    </div>
...
.rightTitleQrCodeVakaryWeb {
  grid-area: 2 / 5 / 3 / 9;
}

.rightSubtitleVakaryWeb {
  grid-area: 3 / 5 / 5 / 9;
