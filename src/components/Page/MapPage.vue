...
<template>
  ...
  <div class="langButtonPos">
    ...
    <img :src="this.$store.state.userStore.userProfileImage" class="flag-button profileIcon" @click="(goToProfilePage)" />
  </div>

  <div class="groupDropdownPosition">
    <div class="widgetPanel">
      <Transition name="slide-fade">
        <div v-if="!displayItineraryInformation && !showGroupCreationModal" :class="(groupDropdownStatus)">
          <div class="dropdown-trigger" @click="(setGroupDropdownState())">
            ...
            <div v-if="this.groupDropdown" style="background-color: white;" class="dropdown-content">
              <div style="display: flex; flex-direction: row;">
              ...
              <div class="topBorder">&nbsp;</div>
              <div v-for="group in this.$store.state.userStore.groups" :key="group.id">
                <Transition name="slide-fade">
                  <mapGroupCardsVue :groupName="group.name" :numberOfMember="group.members.length"
                    @click="groupCardsHasBeenClicked(group.name)" />
                </Transition>
                <div class="topBorder">&nbsp;</div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    groupCardsHasBeenClicked(groupName) {
